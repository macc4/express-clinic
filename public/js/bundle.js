...
exports.submitResolution = exports.getPatientId = void 0;
...
if (submitResolutionForm) {
  submitResolutionForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
      var patient, patientId, resolution, timeToLive;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
            ...
            case 3:
              ...
              timeToLive = document.getElementById('timeToLive').value;
              console.log(patientId);
              console.log(resolution);

              if (resolution) {
                (0, _processPatient.submitResolution)(patientId, resolution, timeToLive);
              }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2151" + '/');
