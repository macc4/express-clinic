...
},{"axios":"../../node_modules/axios/index.js"}],"processPatient.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.dequeue = exports.submitResolution = exports.getPatientId = void 0;
...
var submitResolution = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(patientId, resolution, expiry) {
    var config, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function submitResolution(_x, _x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js"}],"getIntoQueue.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getIntoQueue = void 0;
...
exports.getIntoQueue = getIntoQueue;
...
var _processPatient = require("./processPatient.js");

var _getIntoQueue = require("./getIntoQueue.js");
...
var signoutButton = document.getElementById('btn-signout');
var submitResolutionForm = document.getElementById('form-submit-resolution');
var nextPatientButton = document.getElementById('btn-next-patient');
var getIntoQueueButton = document.getElementById('btn-get-into-queue');

if (signinForm) {
  signinForm.addEventListener('submit', function (event) {
    event.preventDefault();
    var email = signinForm.querySelector('#inputEmail').value;
    var password = signinForm.querySelector('#inputPassword').value;
    (0, _auth.signin)(email, password);
  });
}
...
if (submitResolutionForm) {
  submitResolutionForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
      var patient, patientId, resolution, expiry;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              event.preventDefault();
              _context.next = 3;
              return (0, _processPatient.getPatientId)();

            case 3:
              patient = _context.sent;
              patientId = patient.data.data.patient.patientId;
              resolution = document.getElementById('doctor-new-resolution').value;
              expiry = document.getElementById('timeToLive').value;

              if (resolution) {
                (0, _processPatient.submitResolution)(patientId, resolution, expiry);
              }
